package calculators
{
	 ...
	 */
	public class verhoudingenVermenigvuldigen extends Sprite
	{
		public var calc:form_breukenVermenigvuldigen = new form_breukenVermenigvuldigen();
		public var v1:Verhouding;
		public var v2:Verhouding;
		public var va:Verhouding;
		
		public function verhoudingenVermenigvuldigen() 
		{
			addChild(calc);
			calc.b1.text = "1";
			calc.h1.text = "3";
