package calculators
{
	 ...
	 */
	public class vectorNormeren extends Sprite
	{
		public var u:WVector;
		public var v:WVector;
		public var calc:form_vectorNormeren = new form_vectorNormeren();
		
		public function vectorNormeren() 
		{
			addChild(calc);
			calc.vx.text = "4";
			calc.vy.text = "3";
