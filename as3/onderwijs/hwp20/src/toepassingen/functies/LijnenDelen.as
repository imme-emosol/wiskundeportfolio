package toepassingen.functies 
{
	...
	import wiskunde.objecten.functies.LineairReciprokeFunctie;
	 ...
	 */
	public class LijnenDelen extends Basis
	{
		public var P:Punt;
		public var Q:Punt;
		public var R:Punt;
		...
		public var fg:LineairReciprokeFunctie;
		...
		public function LijnenDelen() 
		{
			...
			fg = new LineairReciprokeFunctie(f.params[0], f.params[1], g.params[0], g.params[1]);
			grafiek_fg = fg.teken( -480, 480,10,0xff0000);
		...
		private function update(e:Event):void
		{
			...
			fg.setParams(f.params[0], f.params[1], g.params[0], g.params[1]);
			grafiek_fg = fg.teken( -480, 480,10,0xff0000);
			rooster.addChild(grafiek_fg);
